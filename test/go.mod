...
require (
	...
	github.com/metal3-io/cluster-api-provider-metal3/api v0.0.0-20221026054644-2dda98a536eb
...
replace sigs.k8s.io/cluster-api/test => sigs.k8s.io/cluster-api/test v1.2.4
